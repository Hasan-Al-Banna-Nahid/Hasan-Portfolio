    ...
    <div>
      ...
      <div className="grid md:grid-cols-3">
        ...
        <div className="card w-96 bg-base-300 shadow-xl mx-auto my-6">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title text-[22px] text-red-800">Doc House</h2>
            <li className="font-bold text-slate-800">
            ...
            <div className="card-actions">
              <button className="btn btn-outline btn-primary">
                <FaEye className="text-[18px] mx-2" />{" "}
                <Link to="https://doc-house.vercel.app/" target="_blank">
                  Live Site
                </Link>
              </button>
        ...
        {/* <div className="card w-96 bg-base-300 shadow-xl mx-auto my-6">
          <Carousel className="w-[400px]" width={380} dynamicHeight={380}>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092251.png" />
            </div>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092306.png" />
            </div>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092317.png" />
            </div>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092332.png" />
            </div>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092357.png" />
            </div>
            <div>
              <img src="/Potential/Screenshot 2023-08-18 092409.png" />
            </div>
          </Carousel>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-[22px] text-red-800">Potential</h2>
            <li className="font-bold text-slate-800">
              This is a Software Companies Personal Site
            </li>{" "}
            <br />
            <li className="font-bold text-slate-800">
              There Is A Landing page For Company Profile
            </li>{" "}
            <li className="font-bold text-slate-800">
              Authentication System Included
            </li>{" "}
            <div className="card-actions">
              <button className="btn btn-outline btn-primary">
                <FaEye className="text-[18px] mx-2" />{" "}
                <Link to="https://potential-c10ec.web.app/" target="_blank">
                  Live Site
                </Link>
              </button>
              ...
              <button className="btn btn-outline btn-info">
                <FaGithub className="text-[18px] mx-2" />{" "}
                <Link
                  to="https://github.com/Hasan-Al-Banna-Nahid/Potential"
                  target="_blank"
                >
                  Source Code Client Side
                </Link>
